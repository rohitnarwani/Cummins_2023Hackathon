...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton.setGeometry(QtCore.QRect(260, 150, 101, 31))
        self.pushButton.setObjectName("pushButton")
        self.label_4 = QtWidgets.QLabel(self.graph)
        self.label_4.setGeometry(QtCore.QRect(420, 30, 281, 141))
        self.label_4.setObjectName("label_4")
        self.DietPlan = QtWidgets.QLabel(self.graph)
        self.DietPlan.setGeometry(QtCore.QRect(250, 290, 321, 171))
        self.DietPlan.setObjectName("DietPlan")
