...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <a class="navbar-brand" href="#"><img style="width: 50px;" class="logoimg" src="LOGO.png" alt=""></a>
    ...
    <div class="container mt-4">
        <h3><?php echo "Welcome ". $_SESSION['username']?> Here is your Token</h3>
        <hr>
    ...
    <div class="wrapper text-center hideprint">
        <img src="/Ticket System/php/good-food-is-good-mood-free-vector.jpg" class="img-fluid" alt="E SUMMIT">
    </div>
    <!-- content -->
